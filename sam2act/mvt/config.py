...
_C.phase_graph_num_classes = 0
_C.role_graph_enabled = False
_C.role_graph_num_classes = 0
_C.role_graph_hidden_dim = 128
_C.role_graph_bias_scale = 0.0
_C.anchor_use_bias_scale = 0.0
_C.role_contrastive_dim = 64
