...
_C.spatial_graph_grip_thresh = 0.35
_C.spatial_graph_feat_sim_thresh = 0.2
_C.spatial_graph_summary_max_nodes = 16
_C.spatial_graph_raw_max_nodes = -1
_C.spatial_graph_soft_bias_scale = 0.5
_C.spatial_graph_transition_bias_scale = 1.5
_C.spatial_graph_grip_bias_scale = 0.5
_C.spatial_graph_use_query_pos_bias = False
_C.spatial_graph_query_pos_scale = 0.25
