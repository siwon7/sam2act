...
GPU="${GPU:-7}"
MODEL_FOLDER="${MODEL_FOLDER:-/hdd4/siwon/checkpoints/sam2act/runs/sam2act_stage2_oracle_put_block_back_dirty_stage1_smoke}"
MODEL_NAME="${MODEL_NAME:-model_plus_last.pth}"
EVAL_DATAFOLDER="${EVAL_DATAFOLDER:-/hdd4/siwon/datasets/sam2act/data_memory/test}"
