...
def main() -> None:
    ...
    parser.add_argument("--repo-code-root", default=os.path.join(os.path.dirname(__file__), "..", "sam2act"))
    parser.add_argument("--data-root", default=os.path.join(os.path.dirname(__file__), "..", "sam2act", "data_memory", "test"))
